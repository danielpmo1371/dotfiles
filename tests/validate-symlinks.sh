...
check_symlink "$HOME/.config/tmux-palette" "$DOTFILES_ROOT/config/tmux-palette" "tmux-palette"
...
check_source_exists "$DOTFILES_ROOT/config/tmux-palette/palettes/claude.json" "tmux-palette/palettes/claude.json"
